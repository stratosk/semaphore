...
echo "CF-Root 4.3" >> /customkernel/property/customkernel.namedisplay 
echo 82 >> /customkernel/property/customkernel.version.number 
echo 4.3 >> /customkernel/property/customkernel.version.name 
